      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="index2.html"><i class="fa fa-circle-o"></i> Entri Pesan Hotel</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?= base_url()?>pages/admin"><i class="fa fa-circle-o"></i>Entri Pesan Kereta</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url()?>admin/jadwal"><i class="fa fa-circle-o"></i>Entri Data Pesawat</a></li>
            <li><a href="<?= base_url()?>admin/pemesanan"><i class="fa fa-circle-o"></i>Entri Pesan Pesawat</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i>Entri Meja</a></li>
            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i>Entri Order</a></li>
            <li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i>Entri Transaksi</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?= base_url()?>pages/owner"><i class="fa fa-circle-o"></i> Owner</a></li>

            <li><a href="<?= base_url()?>pages/menejer"><i class="fa fa-circle-o"></i> Menejer</a></li>
          </ul>
        </li>
        <li>
