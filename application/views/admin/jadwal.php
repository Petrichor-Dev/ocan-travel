          ...
          <tbody >
            ...
            <tr>
              ...
              <td>
                ...
                <a style="padding:1px 10px; float:right; font-weight:lighter; margin-top:3px; border-radius:7px;" href="<?= base_url()?>admin/hapus_jadwal/<?= $jadwal["id_jadwal_pesawat"]?>" class="btn btn-danger" onclick="return confirm('yakin ?');">Hapus</a>
              </td>
            </tr>
            <?php $i++;?>
            <?php endforeach;?>
