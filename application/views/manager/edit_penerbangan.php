      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="jumbotron" style="background-color:#374850; border-radius:30px; padding-top:30px; padding-bottom:30px;">
            <form action="<?= base_url()?>admin/edit_penerbangan/<?= $this->uri->segment(3);?>" method="post">
              ...
              <a href="<?= base_url()?>manager/jadwal" style="margin-left:740px;  display:inline-block; color: #f39c12; margin-top:20px; border-radius: 10px; padding:7px 20px; border: 2px solid#f39c12;"><b>Batal</b></a>
