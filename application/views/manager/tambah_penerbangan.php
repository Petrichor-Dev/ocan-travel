        ...
        <div class="col-lg-12">
          <div class="jumbotron" style="background-color:#374850; border-radius:30px; padding-top:30px; padding-bottom:30px;">
            <form action="<?= base_url()?>admin/tambah_penerbangan" method="post">
              ...
              <a href="<?= base_url()?>manager/jadwal" style="margin-left:710px;  display:inline-block; color: #00c0ef; margin-top:20px; border-radius: 10px; padding:7px 20px; border: 2px solid #00c0ef;"><b>Batal</b></a>
